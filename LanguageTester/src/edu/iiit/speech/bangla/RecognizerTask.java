					...
					if (hyp != null) {
						...
						if (hypstr != partial_hyp) {
							...
							if (this.rl != null && hyp != null) {
								Bundle b = new Bundle();
								String hypoString = hyp.getHypstr();
								b.putString("hyp", hypoString);
